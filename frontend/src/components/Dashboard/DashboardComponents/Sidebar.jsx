...
function Sidebar({ isOpen, setIsOpen }) {
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-30 w-64 transform bg-white shadow-lg transition-transform duration-200 ease-in-out lg:relative lg:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
            ...
            <nav className="px-2">
              <ul className="space-y-1">
                ...
                <li>
                  <Link
                    to="/dashboard"
                    className="flex items-center gap-2 rounded-md bg-gray-100 px-3 py-2 text-blue-600 font-medium"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
